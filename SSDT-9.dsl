 ...
 *
 * Disassembly of SSDT-9.aml, Fri Jul 28 23:52:25 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000182A (6186)
 *     Revision         0x01
 *     Checksum         0xC4
 *     OEM ID           "SgRef"
 *     OEM Table ID     "SgPeg"
...
{
    External (_SB_.PCI0.IGPU._DOD, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (_SB_.PCI0.IGPU.DD02._BCL, IntObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.DD02._BCM, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.DD02._BQC, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.PEGP.GC6I, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.GC6O, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (GBAS, FieldUnitObj)    // (from opcode)
    External (GPRW, MethodObj)    // 2 Arguments (from opcode)
    External (HLRS, FieldUnitObj)    // (from opcode)
    External (HYSS, FieldUnitObj)    // (from opcode)
    External (P0UB, FieldUnitObj)    // (from opcode)
    External (PCSL, FieldUnitObj)    // (from opcode)
    External (PNHM, FieldUnitObj)    // (from opcode)
    External (PWEN, FieldUnitObj)    // (from opcode)
    External (PWOK, FieldUnitObj)    // (from opcode)
    External (SC7A, FieldUnitObj)    // (from opcode)
