 ...
 *
 * Disassembly of SSDT-8.aml, Fri Jul 28 23:52:25 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003D3F (15679)
 *     Revision         0x01
 *     Checksum         0xB2
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
{
    External (_SB_.MPDR, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.AR02, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.AR0A, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.AR0B, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PR02, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PR0A, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PR0B, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.WBCL, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PEPD, UnknownObj)    // (from opcode)
    External (_SB_.WPS0, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.WPS3, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (PICM, IntObj)    // (from opcode)
    ...
    External (SCIS, FieldUnitObj)    // (from opcode)

    OperationRegion (SANV, SystemMemory, 0xAD78EE18, 0x016D)
                ...
                Method (_BCL, 0, Serialized)  // _BCL: Brightness Control Levels
                {
                    ...
                    Else
                    {
                        While (One)
                        {
                            ...
                            If ((_T_1 == Zero))
                            {
                                \_SB.PCI0.IGPU.AINT (0x03, 0x0F)
                                Return (\_SB.PCI0.WBCL (Zero))
                            }
                            ElseIf ((_T_1 == One))
                            {
                                \_SB.PCI0.IGPU.AINT (0x03, 0x1A)
                                Return (\_SB.PCI0.WBCL (One))
                            }
                            Else
                            {
                                Return (\_SB.PCI0.WBCL (One))
